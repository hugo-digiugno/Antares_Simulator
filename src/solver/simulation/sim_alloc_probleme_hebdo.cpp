    ...
    const std::vector<double>& precomputedInitialLevels)
{
    ...
    // CORRESPONDANCES_DES_VARIABLES (deleted copy ctor) - copy member-by-member
    {
        ...
        for (std::size_t i = 0; i < n; ++i)
        {
            ...
            d.NumeroDeVariableCoutOrigineVersExtremiteDeLInterconnexion
              = s.NumeroDeVariableCoutOrigineVersExtremiteDeLInterconnexion;
            d.NumeroDeVariableCoutExtremiteVersOrigineDeLInterconnexion
              = s.NumeroDeVariableCoutExtremiteVersOrigineDeLInterconnexion;
